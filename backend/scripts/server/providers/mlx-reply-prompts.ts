...
export type PromptFormat = "raw_json" | "situation_card" | "direct_scene";
export type ScenePromptFormat = PromptFormat | "scene_state_min";
export type FinalReplyRewriteSeed = {
  draftReplyText: string;
  selectedActionType: string | null;
  selectedActionReason: string | null;
};

export function resolveSystemPrompt(npcId: string, promptFormat: ScenePromptFormat) {
...
export function resolveInteractionContract(input: GenerateInteractionInput) {
